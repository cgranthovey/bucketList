...
class AddPriceVC: UIViewController {
    ...
    let option2 = txtImg.init(txt: "< $10", img: #imageLiteral(resourceName: "coin"))
    let option3 = txtImg.init(txt: "< $25", img: #imageLiteral(resourceName: "coins"))
    let option4 = txtImg.init(txt: "< $50", img: #imageLiteral(resourceName: "notes"))
    let option5 = txtImg.init(txt: "< $100", img: #imageLiteral(resourceName: "notesBundle"))
    let option6 = txtImg.init(txt: "$100+", img: #imageLiteral(resourceName: "rich"))
